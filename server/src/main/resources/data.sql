...
('extra_play', '{"display_name":"额外出牌券","description":"出牌次数+1","price":10,"rarity":0,"item_type":1,"shop_weights":[30,30,30,25,20,15],"effect_class":"ExtraPlay","level_params":[{"extra_plays":1}]}'),
('free_refresh', '{"display_name":"刷新券","description":"下次商店刷新免费","price":5,"rarity":0,"item_type":1,"shop_weights":[40,40,40,35,30,25],"effect_class":"FreeRefresh","level_params":[]}');
